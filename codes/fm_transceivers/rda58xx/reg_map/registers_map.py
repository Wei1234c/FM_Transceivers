...
1 = Bass boost enabled'''),
                                          Element(name = 'RCLK_NON_CALIBRATE_MODE', idx_lowest_bit = 11, n_bits = 1,
                                                  value = 0,
...
1=RCLK clock is not always supply when FM work ( when 1, RDA5820NS can't directly support -20 degree C ~ 70 degree C temperature. Only suppory -20~+20 degree C temperature swing  from tune point)'''),
                                          Element(name = 'RCLK_DIRECT_INPUT_MODE', idx_lowest_bit = 10, n_bits = 1,
                                                  value = 0,
...
If 0, afc work;
If 1, afc disabled.'''),
                                          Element(name = 'Reserved_7', idx_lowest_bit = 7, n_bits = 1, value = 0,
                                                  read_only = True,
                                                  description = '''Reserved'''),
...
10= adjacent seek process || noise condition'''),
                                          Element(name = 'Reserved_12', idx_lowest_bit = 12, n_bits = 1, value = 0,
                                                  read_only = True,
                                                  description = '''Reserved'''),
...
4'b0000: WS_STEP=8kbps;'''),
    ...
    registers.append(Register(name = '0x07', address = 7, description = '''0x07''',
                              elements = [Element(name = 'Reserved_15', idx_lowest_bit = 15, n_bits = 1, value = 0,
                                                  read_only = True,
...
0 = 50~76 MHz.'''),
                                          Element(name = 'Reserved_8', idx_lowest_bit = 8, n_bits = 1, value = 0,
                                                  read_only = True,
                                                  description = '''Reserved'''),
...
0 = the current channel is not a station'''),
                                          Element(name = 'FM_READY', idx_lowest_bit = 7, n_bits = 1, value = 0,
                                                  description = '''1=ready
0=not ready'''),
                                          Element(name = 'Reserved_5', idx_lowest_bit = 5, n_bits = 2, value = 0,
                                                  read_only = True,
                                                  description = '''Reserved'''),
...
1110 = ADC'''),
    ...
    registers.append(Register(name = '0x41', address = 65, description = '''0x41''',
                              elements = [Element(name = 'Reserved_12', idx_lowest_bit = 12, n_bits = 4, value = 0,
                                                  read_only = True,
                                                  description = '''Reserved'''),
