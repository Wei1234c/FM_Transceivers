from utilities.register import RegistersMap, Register, Element, _elements_by_attr


status = Register(name = 'POWER_UP_argument_0', address = 0,
                  elements = [Element(name = 'CTS', idx_lowest_bit = 7, n_bits = 1, value = 0,
                                      description = '''CTS'''),
                              Element(name = 'ERR', idx_lowest_bit = 6, n_bits = 1, value = 0,
                                      description = '''ERR'''),
                              Element(name = 'Reserved_5', idx_lowest_bit = 5, n_bits = 1,
                                      value = 0, read_only = True,
                                      description = '''Reserved'''),
                              Element(name = 'Reserved_4', idx_lowest_bit = 4, n_bits = 1,
                                      value = 0, read_only = True,
                                      description = '''Reserved'''),
                              Element(name = 'Reserved_3', idx_lowest_bit = 3, n_bits = 1,
                                      value = 0, read_only = True,
                                      description = '''Reserved'''),
                              Element(name = 'RDSINT', idx_lowest_bit = 2, n_bits = 1, value = 0,
                                      description = '''RDSINT'''),
                              Element(name = 'ASQINT', idx_lowest_bit = 1, n_bits = 1, value = 0,
                                      description = '''ASQINT'''),
                              Element(name = 'STCINT', idx_lowest_bit = 0, n_bits = 1, value = 0,
                                      description = '''STCINT'''),
                              ], default_value = 0)
...
class Command:
    ...
    def __init__(self, name: str, code: int, description = None,
                 arguments = None, responses = None):
        self.name = name
        self.code = code
        self.description = description
        self.arguments = RegistersMap(name = name + '_arguments', registers = arguments)
        self.responses = RegistersMap(name = name + '_responses', registers = responses)



class CommandSet:

    def __init__(self, name, description = None, commands = None):
        self.name = name
        self.description = description
    ...
    def commands(self, commands):
        ...
        self._commands_dict = _elements_by_attr(self._commands, 'name')
        self._commands_by_code = _elements_by_attr(self._commands, 'code')


    @property
    def commands_by_code(self):
        return self._commands_by_code
...
1 = CTS interrupt enabled.'''),
                                                     Element(name = 'GPO2OEN', idx_lowest_bit = 6, n_bits = 1,
                                                             value = 0,
...
00001111 = Digital audio inputs (DIN/DFS/DCLK)'''),
                            ...
                            responses = [
                                ...
                                Register(name = 'POWER_UP_response_2', address = 2,
                                         elements = [
                                             Element(name = 'FWMAJOR', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                     description = '''Firmware Major Revision.'''),
                                             ], default_value = 0),
                                Register(name = 'POWER_UP_response_3', address = 3,
                                         elements = [
                                             Element(name = 'FWMINOR', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                     description = '''Firmware Minor Revision.'''),
                                             ], default_value = 0),
                                Register(name = 'POWER_UP_response_4', address = 4,
                                         elements = [
                                             Element(name = 'Reserved_0', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                     read_only = True,
                                ...
                                Register(name = 'POWER_UP_response_6', address = 6,
                                         elements = [
                                             Element(name = 'CHIPREV', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                     description = '''Chip Revision.'''),
                                             ], default_value = 0),
                                Register(name = 'POWER_UP_response_7', address = 7,
                                         elements = [
                                             Element(name = 'LIBRARYID', idx_lowest_bit = 0, n_bits = 8, value = 0,
    ...
    commands.append(Command(name = 'GET_REV', code = 16,
                            ...
                            responses = [
                                ...
                                Register(name = 'GET_REV_response_6', address = 6,
                                         elements = [
                                             Element(name = 'CMPMAJOR', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                     description = '''Component Major Revision'''),
                                             ], default_value = 0),
                                Register(name = 'GET_REV_response_7', address = 7,
                                         elements = [
                                             Element(name = 'CMPMINOR', idx_lowest_bit = 0, n_bits = 8, value = 0,
...
This byte in combination with FREQL selects the tune frequency in units of 10 kHz. The valid range is from 7600 to 10800 (76–108 MHz). The frequency must be a multiple of 50 kHz.'''),
                                                     ], default_value = 0),
...
This byte in combination with FREQH selects the tune frequency in units of 10 kHz. The valid range is from 7600 to 10800 (76–108 MHz). The frequency must be a multiple of 50 kHz.
...
'''),
    ...
    commands.append(Command(name = 'TX_TUNE_POWER', code = 49,
                            description = '''Sets the RF voltage level between 88 dBμV and 115 dBμV in 1 dB units. Power may be set as high as 120 dBμV; however, voltage accuracy is not guaranteed. A value of 0x00 indicates off. The command also sets the antenna tuning capacitance. A value of 0 indicates autotuning, and a value of 1–191 indicates a manual override. The CTS bit (and optional interrupt) is set when it is safe to send the next command. The ERR bit (and optional interrupt) is set if an invalid argument is sent. Note that only a single interrupt occurs if both the CTS and ERR bits are set. The optional STC interrupt is set when the command completes. The STCINT bit is set only after the GET_INT_STATUS command is called. This command may only be sent when in powerup mode. The command clears the STC bit if it is already set. See Figure 29, “CTS and STC Timing Model,” on page 244 and Table 48, “Command Timing Parameters for the FM Transmitter,” on page 245.''',
                            arguments = [
                                ...
                                Register(name = 'TX_TUNE_POWER_argument_3', address = 3,
                                         elements = [Element(name = 'RFdBμV', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                             description = '''Tune Power Byte.
Sets the tune power in dBμV in 1 dB steps. The valid range is from 88– 115 dBμV. Power may be set as high as 120 dBμV; however, voltage accu- racy is not guaranteed.'''),
                                                     ], default_value = 0),
    ...
    commands.append(Command(name = 'TX_TUNE_MEASURE', code = 50,
                            ...
                            arguments = [
                                ...
                                Register(name = 'TX_TUNE_MEASURE_argument_2', address = 2,
                                         elements = [Element(name = 'FREQH', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                             description = '''Tune Frequency High Byte.
This byte in combination with FREQL selects the tune frequency in units of 10 kHz. In FM mode the valid range is from 7600 to 10800 (76–108 MHz). The frequency must be a multiple of 50 kHz.'''),
                                                     ], default_value = 0),
                                Register(name = 'TX_TUNE_MEASURE_argument_3', address = 3,
                                         elements = [Element(name = 'FREQL', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                             description = '''Tune Frequency Low Byte.
This byte in combination with FREQH selects the tune frequency in units of 10 kHz. In FM mode the valid range is from 7600 to 10800 (76–108 MHz). The frequency must be a multiple of 50 kHz.'''),
                                                     ], default_value = 0),
...
'''),
    ...
    commands.append(Command(name = 'TX_TUNE_STATUS', code = 51,
                            description = '''Returns the status of the TX_TUNE_FREQ, TX_TUNE_MEASURE, or TX_TUNE_POWER commands. The command returns the current frequency, output voltage in dBμV (if applicable), the antenna tuning capacitance value (0–191) and the received noise level (if applicable). The command clears the STCINT interrupt bit when INTACK bit of ARG1 is set. The CTS bit (and optional interrupt) is set when it is safe to send the next command. This command may only be sent when in powerup mode.''',
                            arguments = [
                                Register(name = 'TX_TUNE_STATUS_argument_1', address = 1,
                                         elements = [
                                             Element(name = 'Reserved_1', idx_lowest_bit = 1, n_bits = 7, value = 0,
                                                     read_only = True,
                                                     description = '''Always write to 0.'''),
...
If set this bit clears the seek/tune complete interrupt status indicator.'''),
                            ...
                            responses = [
                                ...
                                Register(name = 'TX_TUNE_STATUS_response_2', address = 2,
                                         elements = [
                                             Element(name = 'READFREQH', idx_lowest_bit = 0, n_bits = 8, value = 0,
...
This byte in combination with READFREQL returns frequency being tuned.'''),
                                ...
                                Register(name = 'TX_TUNE_STATUS_response_3', address = 3,
                                         elements = [
                                             Element(name = 'READFREQL', idx_lowest_bit = 0, n_bits = 8, value = 0,
...
This byte in combination with READFREQH returns frequency being tuned.'''),
                                ...
                                Register(name = 'TX_TUNE_STATUS_response_5', address = 5,
                                         elements = [
                                             Element(name = 'READRFdBμV', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                     description = '''Read Power.
Returns the transmit output voltage setting.'''),
                                             ], default_value = 0),
                                Register(name = 'TX_TUNE_STATUS_response_6', address = 6,
                                         elements = [
                                             Element(name = 'READANTCAP', idx_lowest_bit = 0, n_bits = 8, value = 0,
...
1 = Clears ASQINT, OVERMOD, IALDH, and IALDL.'''),
                            ...
                            responses = [
                                Register(name = 'TX_ASQ_STATUS_response_1', address = 1,
                                         elements = [
                                             Element(name = 'OVERMOD', idx_lowest_bit = 2, n_bits = 1, value = 0,
...
1 = Input audio level low threshold exceeded.'''),
                                ...
                                Register(name = 'TX_ASQ_STATUS_response_4', address = 4,
                                         elements = [
                                             Element(name = 'INLEVEL', idx_lowest_bit = 0, n_bits = 8, value = 0,
...
If set, the command operates on the FIFO buffer. If cleared, the command operates on the circular buffer.'''),
                                                     Element(name = 'Reserved_3', idx_lowest_bit = 3, n_bits = 4,
                                                             value = 0, read_only = True,
                                                             description = '''Always write to 0.'''),
...
This byte in combination with RDSDH sets the RDS block D data.'''),
                            ...
                            responses = [
                                Register(name = 'TX_RDS_BUFF_response_1', address = 1,
                                         elements = [
                                             Element(name = 'Reserved_5', idx_lowest_bit = 5, n_bits = 3, value = 0,
                                                     read_only = True,
                                ...
                                Register(name = 'TX_RDS_BUFF_response_2', address = 2,
                                         elements = [
                                             Element(name = 'CBAVAIL', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                ...
                                Register(name = 'TX_RDS_BUFF_response_4', address = 4,
                                         elements = [
                                             Element(name = 'FIFOAVAIL', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                                     description = '''Returns the number of available FIFO blocks.'''),
                                             ], default_value = 0),
                                Register(name = 'TX_RDS_BUFF_response_5', address = 5,
                                         elements = [
                                             Element(name = 'FIFOUSED', idx_lowest_bit = 0, n_bits = 8, value = 0,
                                ...
                                Register(name = 'TX_RDS_PS_argument_1', address = 1,
                                         elements = [
                                             ...
                                             Element(name = 'PSID', idx_lowest_bit = 0, n_bits = 5, value = 0,
                                                     description = '''Selects which PS data to load (0–23)
...
2. The use of GPO2 as an interrupt pin and/or the use of GPO3 as DCLK digital clock input will override this GPIO_CTL function for GPO2 and/or GPO3 respectively.''',
                            arguments = [
                                Register(name = 'GPIO_CTL_argument_1', address = 1,
                                         elements = [
                                             Element(name = 'Reserved_4', idx_lowest_bit = 4, n_bits = 4, value = 0,
                                                     read_only = True,
...
def _get_commands():
    return CommandSet(name = 'Si47xx Command Set', description = 'Si47xx Command Set', commands = _get_all_commands())
